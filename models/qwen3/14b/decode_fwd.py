...
def _decode_layer(  # noqa: PLR0913 — model signature is intrinsic
    ...
    with pl.manual_scope():
        ...
        # Per-k task_dummy funnel for the deferred (non-critical) gate/up tiles.
        # Gate and up share it: both funnel the SAME dependency (cast_tids[k]),
        # so one dummy per K-slice serves both (fewer host tasks / dep edges).
        ...
        cast_late_tids = pl.array.create(K_SPLITS_MLP, pl.TASK_ID)
        ...
        #     (cast_late_tids, shared by gate and up).
        ...
        for k_split in pl.unroll(K_SPLITS_MLP):
            ...
            cast_late_tids[k_split] = pl.system.task_dummy(deps=[cast_tids[k_split]])
